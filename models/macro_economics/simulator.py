...
def simulation_registry():
    ...
    from macro_economics.substeps.earning.action import WorkConsumptionPropensity
    reg.register(WorkConsumptionPropensity, "get_work_consumption_decision", key="policy")
    
    from macro_economics.substeps.earning.transition import UpdateAssets, WriteActionToState
    ...
    from macro_economics.substeps.financial_market.transition import UpdateFinancialMarket
    ...
    from macro_economics.substeps.utils import random_normal_col_by_col, load_population_attribute, initialize_id
