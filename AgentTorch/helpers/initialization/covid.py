...
def get_mean_agent_interactions(shape, params):
    ...
    agents_mean_interactions[child_agents.bool(), 22] = mean_int_ran_mu[0]
    agents_mean_interactions[adult_agents.bool(), 22] = mean_int_ran_mu[1]
    agents_mean_interactions[elderly_agents.bool(), 22] = mean_int_ran_mu[2]
