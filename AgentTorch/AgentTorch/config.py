...
class Configurator(nn.Module):
    ...
    def create_function(self, generator, fn_type, arguments=None, input_variables=None, output_variables=None):
    ...
    def add_network(self, network_name, network_type, arguments, category='agent_agent'):
        ...
        _network_obj.update({network_name: {'type': network_type_key, 'arguments': arguments}})
        self.config['state']['network'].update({category: _network_obj})


    def add_substep(self, name, active_agents, observation_fn=None, policy_fn=None, transition_fn=None):
