...
def process_nta_agent(NTA_ID):
    ...
    education_prob = [nta_education[key_ix]['probability'][0] for key_ix in nta_education]
    insurance_employ_prob = [nta_employ_insure[key_ix]['probability'][0] for key_ix in nta_employ_insure]
