...
CENSUS_DATA_ROOT = './census_nyc/'

demographic_file = os.path.join(CENSUS_DATA_ROOT, 'nta/demo_2021acs5yr_nta.xlsx')
economic_file = os.path.join(CENSUS_DATA_ROOT,'nta/econ_2021acs5yr_nta.xlsx')
social_file = os.path.join(CENSUS_DATA_ROOT, 'nta/soc_2021acs5yr_nta.xlsx')
housing_file = os.path.join(CENSUS_DATA_ROOT, 'nta/hous_2021acs5yrr_nta.xlsx')
...
relationship_file = os.path.join(CENSUS_DATA_ROOT, 'nyc2020census_tract_nta_cdta_relationships.xlsx')
