...
income_mapping_legacy = {
    "U25": ["HHIU10", "HHI10t14", "HHI15t24"],
    "25t49": ["HHI25t34", "HHI35t49"],
    "50t99": ["HHI50t74", "HHI75t99"],
    "100t199": ["HI100t149", "HI150t199"],
    "200A": ["HHI200pl"],
}

income_mapping = {
    "U15": ["HHIU10", "HHI10t14"],
    "15t35": ["HHI15t24", "HHI25t34"],
    "35t49": ["HHI35t49"],
    "50t74": ["HHI50t74"],
    "75t99": ["HHI75t99"],
    "100t149": ["HI100t149"],
...
ownership_mapping = {
    "renter": ["ROcHU1"],
    "no_mortgage_owner": ["HUnoMrtg1"],
    "mortgage_owner": ["HUwMrtg"],
}
...
def get_nta_household_ownership(df, nta_id, ownership_mapping):
    ...
    for ownership_type in ownership_mapping:
        ...
        estimate, percentage = merge_nta_stats(
            nta_df, ownership_mapping[ownership_type]
        )

        nta_household_ownership[ownership_type]["estimate"] = estimate

    all_households = sum(
        [nta_household_ownership[o_type]["estimate"] for o_type in ownership_mapping]
    )

    # compute probability
    for ownership_type in ownership_mapping:
        nta_household_ownership[ownership_type]["probability"] = (
            nta_household_ownership[ownership_type]["estimate"] / all_households
        )
