...
class PropertyBuilder:
    def __init__(self, name: str, dtype: str = None, shape: List[Union[int, str]] = None, 
                 learnable: bool = False, value: Any = None, 
    ...
    @classmethod
    def create_argument(cls, name: str, value: Any, dtype: str = "float", 
                       shape: List[int] = None, learnable: bool = False) -> 'PropertyBuilder':
    ...
    def set_initialization(self, generator: str, arguments: Dict[str, Any]) -> 'PropertyBuilder':
...
class AgentBuilder:
    ...
    def add_property(self, property_builder: PropertyBuilder) -> 'AgentBuilder':
        self.config["properties"][property_builder.config["name"]] = property_builder.config
        return self
...
class NetworkBuilder:
    ...
    def add_network(self, name: str, network_type: str, arguments: Dict[str, Any]) -> 'NetworkBuilder':
