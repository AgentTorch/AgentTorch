...
class ObservationBuilder:
    ...
    def add_observation(self, name: str, input_vars: Dict[str, str], output_vars: List[str], arguments: Dict[str, Any]) -> 'ObservationBuilder':
        self.config[name] = {
...
class PolicyBuilder:
    ...
    def add_policy(self, name: str, generator: str, input_vars: Dict[str, str], 
                  output_vars: List[str], arguments: Dict[str, Any]) -> 'PolicyBuilder':
        self.config[name] = {
            "generator": generator,
            "input_variables": input_vars,
            "output_variables": output_vars,
...
class TransitionBuilder:
    ...
    def add_transition(self, name: str, generator: str, input_vars: Dict[str, str],
                      output_vars: List[str], arguments: Dict[str, Union[Dict[str, Any], PropertyBuilder]]) -> 'TransitionBuilder':
...
class SubstepBuilder:
    ...
    def set_observation(self, agent_type: str, obs_config: Optional[Dict[str, Any]] = None) -> 'SubstepBuilder':
        self.config["observation"][agent_type] = obs_config
        return self
    
    def set_policy(self, agent_type: str, policy_builder: PolicyBuilder) -> 'SubstepBuilder':
...
class ConfigBuilder:
    ...
    def add_substep(self, step_id: str, substep_builder: SubstepBuilder) -> 'ConfigBuilder':
