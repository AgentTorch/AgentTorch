from state_builder import StateBuilder, AgentBuilder, PropertyBuilder, EnvironmentBuilder, NetworkBuilder
from substep_builder import ConfigBuilder, SubstepBuilder, PolicyBuilder, TransitionBuilder
...
def create_covid_config():
    ...
    disease_stage_prop = PropertyBuilder("disease_stage")\
        .set_dtype("int")\
        .set_shape([metadata["num_agents"], 1])\
    ...
    sf_infector = PropertyBuilder("SFInfector")\
        .set_dtype("float")\
        .set_shape([5])\
